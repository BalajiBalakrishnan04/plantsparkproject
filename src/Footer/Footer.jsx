...
<p className='flex flex-col text-[white] [@media(min-width:1200px)]:text-[18px] [@media(min-width:900px)]:text-[16px] indent-[15px] leading-[1.5]'>Explore a diverse collection of indoor and outdoor plants, stylish pots, and essential gardening tools. Get swift delivery, expert care guidance, and a seamless shopping experience. Transform your space with lush greenery effortlessly!</p>
        </div>
        <ul className='w-[25%] list-none text-[white] [@media(min-width:1200px)]:text-[18px] [@media(min-width:900px)]:text-[16px] flex flex-col gap-[15px] items-center cursor-pointer'>
              <li >QUICK LINKS</li>
        ...
        <div className='w-[35%] flex flex-col gap-[15px]  text-[white] [@media(min-width:1200px)]:text-[18px] [@media(min-width:900px)]:text-[16px]'>
